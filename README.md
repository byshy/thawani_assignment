...
> **Status:** `sdk/needle` and `sdk/thawani_models` exist. Remaining SDK packages and Explorer are still to be scaffolded.
...
- Implementation started: `sdk/needle` and `sdk/thawani_models`. Remaining SDK packages and Explorer are not scaffolded yet.
